...
namespace Hands.ViewModels.Models
{
    public class noor
    {
        ...
        public int LhvId { get; set; }

        public int? ProjectId { get; set; } // ProjectId
        public IEnumerable<Hands.Data.HandsDB.SpGetAllMarviWithNamesReturnModel> NoorList { get; set; }

        public IList<Data.HandsDB.AppUser> AppUsers;
        public IEnumerable<Region> Regions { get; set; }
        public IEnumerable<AppUser> Marvis { get; set; }

        public IEnumerable<AppUser> Lhvs { get; set; }
