...
namespace Hands.ViewModels.Models
{
    public class NewMwra
    {
        ...
        [Required]
        [StringLength(50, ErrorMessage = "User   cannot be longer than 50 characters")]
      ...
      //  [Required]
       ...
       // [Required]
        ...
        public MwraClientNew clientData { get; set; }
        public Data.HandsDB.Mwra GetMwraEntity()
        {
            ...
            mwra.FpMethodUsed = FpMethodUsed != null ? FpMethodUsed.Replace("\n", " ") : FpMethodUsed;
            ...
            mwra.IsActive = true;
            mwra.DeviceCreatedDate = DeviceCreatedDate;
            return mwra;
