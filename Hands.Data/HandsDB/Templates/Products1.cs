...
namespace Hands.Data.HandsDB
{
    ...
    public partial class Products1 : Entity
    {
        ...
        /// <summary>
        /// Child BlmisSellHistories where [BlmisSellHistory].[ProductId] point to this entity (FK_BlmisSellHistory_products)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<BlmisSellHistory> BlmisSellHistories { get; set; } // BlmisSellHistory.FK_BlmisSellHistory_products

        public Products1()
        {
            CreatedAt = System.DateTime.Now;
            IsActive = true;
            BlmisSellHistories = new System.Collections.Generic.List<BlmisSellHistory>();
            InitializePartial();
        }
