...
using Hands.ViewModels.Models.Products;
...
namespace Hands.Web.Controllers
{
    public class ProductsController : ControllerBase
    {
        ...
        {
            // GET: Noor
            var schemeList = _productsService.GetAllProductByType("clmis").OrderByDescending(x=>x.ProductId);
        ...
        public ActionResult Create()
        {
            ...
            productsModel.Categories = _categoriesService.GetAllActive().Where(x => x.ProjectId == HandSession.Current.ProjectId).ToList();
        ...
        public ActionResult Edit(int id)
        {
            ...
            Viewmodel.Categories = _categoriesService.GetAllActive().Where(x => x.ProjectId == HandSession.Current.ProjectId).ToList();
        ...
        public ActionResult Edit(ViewModels.Models.Products.ProductsModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (existingModel != null)
                {
                    ...
                    existingModel.Producttype = "clmis";
        ...
        {
            IGrid<Hands.Data.HandsDB.Product> grid = new Grid<Hands.Data.HandsDB.Product>(_productsService.GetAllActive().OrderByDescending(x => x.ProductId));
