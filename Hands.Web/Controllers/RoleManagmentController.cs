...
namespace Hands.Web.Controllers
{
    public class RoleManagmentController : ControllerBase
    {
        ...
        // POST: /Roles/Create
        [HttpPost]
        public ActionResult Create(ViewModels.Models.Role collection)
        {
        ...
        public void Edit(string existingvalue , string newvalue) /// modified by ammar 
        {
            //try
            //{
                var context = new Models.ApplicationDbContext();
                var thisRole = context.Roles.Where(r => r.Name.Equals(existingvalue, StringComparison.CurrentCultureIgnoreCase)).FirstOrDefault(); /// modified by ammar 
                thisRole.Name = newvalue;
